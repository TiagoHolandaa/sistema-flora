...
<?php
    include('../controller/conexaoPro.php');
        ...
        $sqlUpdate ="UPDATE tb_produto SET pro_nome='$pro_nome',pro_preco='$pro_preco',pro_quantidade='$pro_quantidade', tb_categoria_has_pro_cat_id='$tb_categoria_has_pro_cat_id'";
