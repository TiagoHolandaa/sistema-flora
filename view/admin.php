            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="row g-2 mb-4">
                        ...
                        <h5 class="card-header">Imagem</h5>
                            <div class="card-body">
                                <p class="card-text">somente imagem: jpg, png, jpeg</p>
                                <a href="#" class="btn btn-transparent"><input multiple name="arquivo[]" type="file" class="form-control"></a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                            <select name="tb_categoria_has_pro_cat_id" class="form-select" id="floatingInputGrid" placeholder="Categoria">
