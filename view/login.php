        ...
        <div class="row ">
            ...
            <div class="col-sm-5 d-flex align-items-center justify-content-center bg-light">
                <form method="POST" action="../model/logar.php">
                    ...
                    <input type="email" class="form-control i-bg" id="inputPassword3">
                    </div>
                    <div class="row mb-2">
                    <label for="exampleDataList" class="form-label px-1 f-size">Senha</label>
                    <input type="password" class="form-control i-bg" id="inputPassword3">
                    </div>
                    ...
                    <center>
                        <button type="submit" class="btn btn-success px-4 mb-3">Entrar</button><br>
