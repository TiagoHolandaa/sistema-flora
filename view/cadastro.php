    ...
    <div class="container-flex">
        <div class="row ">
            ...
            <div class="col-sm-5 d-flex align-items-center justify-content-center bg-light">
                <form class="row mx-5" method="POST" action="../model/logar.php">
                    <p class="h3 mb-3">Cadastrar</p>
                    <div class="col-md-6">
                        <label for="exampleDataList" class="form-label px-1 f-size">Nome</label>
                        <input type="text" class="form-control i-bg" id="inputPassword3">
                    </div>
                    ...
                    <div class="col-12 mb-2">
                        ...
                        <input type="text" class="form-control i-bg" id="inputCPF">
                    </div>
                    <div class="col-12 mb-2">
                        <label for="inputEmail" class="form-label">Email</label>
                        <input type="text" class="form-control i-bg" id="inputEmail">
                    </div>
                    <div class="col-12 mb-3">
                        <label for="inputSenha" class="form-label">Senha</label>
                        <input type="text" class="form-control i-bg" id="inputSenha">
                    </div>
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-success px-5 mb-3">Cadastrar</button>
                    </div>
                    <div class="d-flex justify-content-center">
